...
public class AXAFanpageFansListeningNormal {

	private static final Logger log = LoggerFactory.getLogger(AXAFanpageFansListeningNormal.class);
	...
	public static void main(String[] args) throws IOException, JSONException {
		...
		String pageName = "AXAPeopleProtectors.HongKong";
		String fileName = dateStr + "-Fans-of-" + pageName.replace(" ", "") + ".xls";
		String directory = "D://AXAReport/";
		String path = directory + fileName;
		String pageId = "1495800370678252";
		...
		// }
		//
		totalFanNum += fansParser(path, pageId, pageName, dateStr);
	...
	private static FBUser parserUser(String id) throws JSONException {
		...
		try {
			...
			boolean isHKLocation =false;
			if(null!=hometown&&hometown.contains("Hong Kong")){
				isHKLocation = true;
			}
			
			if(null!=location&&location.contains("Hong Kong")){
				isHKLocation = true;
			}
